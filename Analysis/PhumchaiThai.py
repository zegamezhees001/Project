...
filepath = (r"C:\Users\User\Desktop\ProjectPycharm\CollectData\CleanDataPhumchaiThai.csv")
...
confusion_mat =confusion_matrix(ypred,y_test)
print(confusion_mat)
